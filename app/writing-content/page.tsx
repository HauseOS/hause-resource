    ...
    <>
      <section className="px-6 py-16 border-b border-border">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-4">✍️ Writing & Content Tools</h1>
          <p className="text-lg text-foreground-dim max-w-2xl">
            Write, create, and brainstorm faster with AI-powered writing tools.
          </p>
        </div>
      </section>
