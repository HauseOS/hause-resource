    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-border">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Best AI video and audio production tools</p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-border">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Side-by-side comparison of video tools</p>
        </div>
        <Card>
        ...
        <Card className="bg-secondary">
          <CardContent className="pt-12 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Explore tools for image generation, writing, code, and automation.
            </p>
