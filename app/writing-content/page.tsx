    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6 border-b border-border">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">Writing & Content Tools</h1>
          <p className="text-foreground-muted max-w-2xl">Write, create, and brainstorm faster with AI-powered writing tools.</p>
        </div>
      </section>
