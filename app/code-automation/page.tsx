    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6 border-b border-border">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">Code & Automation Tools</h1>
          <p className="text-foreground-muted max-w-2xl">Build, automate, and code faster with AI-powered development tools.</p>
        </div>
      </section>
